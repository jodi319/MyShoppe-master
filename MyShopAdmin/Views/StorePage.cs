	...
	public class StorePage : ContentPage
	{
		...
		public StorePage (Store store)
		{
			...
			if (Store == null) {
			    ...
			    Store.Image = "http://www.refractored.com/images/SF.png";
			    Store.LocationCode = "SF";
			    Store.LocationHint = "Sansome & Pacific";
			    Store.StreetAddress = "394 Pacific Ave. 4th Floor";
			    Store.State = "CA";
			    Store.PhoneNumber = "855-926-2746";
			    Store.ZipCode = "94111";
			    //Store.Latitude = 37.797788;
			    //Store.Longitude = -122.401858;
                //TEST
